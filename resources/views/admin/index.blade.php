	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-xl-6 col-12">
					<div class="box bg-info bg-img bg1-img" >
						<div class="box-body text-center">							
							<img src="{{asset('backend/images/trophy.png')}}" class="mt-50 filter" alt="" />
					...
					<div class="box overflow-hidden">
						<div class="box-body p-0">
							<div class="row no-gutters">
								...
								<div class="col-md-6 col-12">
									<div class="box no-shadow mb-0 bg-img rounded-0 landscape7-img" data-overlay="5" >
										<div class="box-header no-border">
											<h4 class="box-title mb-0">
									...
									<tbody>
											...
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-20">
														<div class="bg-img h-50 w-50 creative1-img" ></div>
													</div>
										...
										<tr>										
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-20">
														<div class="bg-img h-50 w-50 creative2-img" ></div>
													</div>
										...
										<tr>										
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-20">
														<div class="bg-img h-50 w-50 creative3-img"></div>
													</div>
										...
										<tr>										
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-20">
														<div class="bg-img h-50 w-50 creative4-img"></div>
													</div>
										...
										<tr>										
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0 mr-20">
														<div class="bg-img h-50 w-50 creative5-img"></div>
													</div>
